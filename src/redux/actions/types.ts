...
export enum FRIENDLIST {
  ...
  ClEAR = 'CLEAR_FRIEND',
  REFRESH = 'FRIENDLIST_REFRESH',
  REFRESH_END = 'FRIENDLIST.REFRESH_END',
}
...
export enum GET_DETAIL_GROUP_CHAT {
  START = 'GET-DETAIL-GROUP-CHAT-START',
  END = 'GET-DETAIL-GROUP-CHAT-END',
