            ...
            >
                <View style={styles.modalContainer}>
                    <View style={styles.centeredView}>
                        ...
                        <TouchableOpacity onPress={() => resendOTP(isPhone)} style={{ width: '100%', marginTop: 16 }}>
                            <Text style={{ textAlign: 'right', fontSize: 16, color: mainTheme.logo }}>Gửi lại mã xác nhận</Text>
                        </TouchableOpacity>
