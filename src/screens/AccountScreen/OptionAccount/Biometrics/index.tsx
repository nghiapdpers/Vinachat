import { SafeAreaView, Text, TouchableOpacity, View, FlatList, Image, Switch, Modal, TextInput, KeyboardAvoidingView, Platform } from "react-native";
    ...
    const loadIsBiometricsEnabled = async () => {
        try {
            ...
            if (storedMobile && storedMobile !== mobile) {
                ...
                const isEnabledString = await AsyncStorage.getItem(`@isEnabled_${mobile}`);
        ...
        <SafeAreaView style={styles.container}>
            ...
            <View style={styles.EnableBorder}>
                <View style={styles.FlexBorder}>
                    <Text style={styles.text}>Xác thực {isSupported === 'FaceID is supported' ? 'FaceID' : 'TouchID'}</Text>
                    <Switch
                        ...
                        <View style={styles.BorderModal}>
                            ...
                            {animation === true ? (
                                <View style={styles.ViewAnimation}>
                                    <LottieView
                                        source={isSupported === 'FaceID is supported' ? require('../../../../assets/lottiefile/biometrics/faceid.json') : require('../../../../assets/lottiefile/biometrics/touchid.json')}
                                ...
                                <>
                                    ...
                                    <View style={styles.flexboxbottomModal}>
                                        <TouchableOpacity style={styles.borderbtn} onPress={() => { setModalVisible(false) }}>
                                            <Text style={styles.textbtnModal}>Huỷ</Text>
                                        </TouchableOpacity>
                                        <TouchableOpacity style={styles.borderbtn} onPress={() => { HandleConfirmPass() }}>
